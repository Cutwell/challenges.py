...
n_episodes = 100_000  # Number of games to practice
...
for episode in tqdm(range(n_episodes)):
    ...
    if (episode + 1) % 5000 == 0:
        ...
        avg_length = np.mean(list(env.length_queue)[-100:])
        print(f"Episode {episode+1}: Avg Reward: {avg_reward:.2f}, Avg Length: {avg_length:.2f}, Epsilon: {agent.epsilon:.2f}")
